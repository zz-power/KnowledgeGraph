...
public class JoinerFilterNode extends InnerNode{
	...
	public  JoinerFilterNode() {
		
	}
	
	public JoinerFilterNode(int id, int parent, Term term, String joinColumn) {
		super(id, -1, -1, parent, term);
		this.joinColumn=joinColumn;
	}

	public JoinerFilterNode(int id, int parent, Term childTerm, RDF childRDF, String joinColumn) {
